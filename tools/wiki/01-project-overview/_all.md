g:\Projects\CFI\K12\k12-Arch\wiki\01-project-overview/README.md
```markdown
# Project Overview
...
g:\Projects\CFI\K12\k12-Arch\wiki\01-project-overview/roadmap/README.md
```markdown
# Roadmap
...
## Documents
- [ROADMAP-01: Current Sprint Features](ROADMAP-01-current-sprint-features.md)
- [ROADMAP-02: Feature Roadmap](ROADMAP-02-feature-roadmap.md)

```

g:\Projects\CFI\K12\k12-Arch\wiki\01-project-overview/roadmap/ROADMAP-01-current-sprint-features.md
```markdown
...
- **Checklist ID**: ROADMAP-01
- **Why incomplete**: Needs to be synchronized with the Task Orchestrator feature/task backlog.
...
## Open Questions / TODO
- Pull current sprint scope from the Task Orchestrator and link to feature/task IDs.

```

g:\Projects\CFI\K12\k12-Arch\wiki\01-project-overview/roadmap/ROADMAP-02-feature-roadmap.md
```markdown
...
## Status and Coverage
- **Status**: Draft (Incomplete)
- **Checklist ID**: ROADMAP-02
- **Why incomplete**: Roadmap needs a single view that aligns Confluence planning, repo docs, and Task Orchestrator entities.
...
## Dependencies
- Platform/infrastructure dependencies: TBD

## Open Questions / TODO
- Map features to C4 and standards docs where relevant.
