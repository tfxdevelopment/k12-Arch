...
> **Note:** Dapr Workflows replaces Azure Durable Functions as the preferred workflow orchestration pattern. See [ADR-012](./../../adr/ADR-012-roster-workflow-orchestration.md) for migration guidance.
...
- [ADR-012: Roster Workflow Orchestration](./../../adr/ADR-012-roster-workflow-orchestration.md) (superseded by Dapr Workflows)
