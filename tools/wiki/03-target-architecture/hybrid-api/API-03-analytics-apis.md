...
External repo location (k12-trino): `docker-compose.yml` (not in this repo)
...
External repo location (k12-trino): `etc/config.properties` (not in this repo)
...
External repo location (k12-trino): `etc/node.properties` (not in this repo)
...
External repo location (k12-trino): `etc/jvm.config` (not in this repo)
...
External repo location (k12-trino): `catalog/sqlserver.properties` (not in this repo)
...
External repo location (k12-trino): `catalog/iceberg.properties` (not in this repo)
...
# Create CubeJS project (external repo: k12-cubejs)
# Example workflow in that repo root:
...
External repo location (k12-cubejs): `.env` (not in this repo)
...
External repo location (k12-cubejs): `schema/EnrollmentStats.js` (not in this repo)
...
External repo location (k12-cubejs): `schema/AwardUtilization.js` (not in this repo)
...
External repo location (k12-cubejs): `schema/SchoolCompliance.js` (not in this repo)
...
External repo location (k12-cubejs): `schema/ExecutiveKPIs.js` (not in this repo)
...
```bash
# External repo: k12-cubejs (not in this repo)
# In that repo root:
...
External repo location (k12-web-enrollment): `projects/admin/src/app/services/cubejs.service.ts` (not in this repo)
...
External repo location (k12-web-enrollment): `projects/admin/src/app/components/enrollment-dashboard.component.ts` (not in this repo)
...
```bash
# External repos: k12-trino and k12-cubejs (not in this repo)
# In each repo root:
# docker-compose up -d
# npm run prod
```
