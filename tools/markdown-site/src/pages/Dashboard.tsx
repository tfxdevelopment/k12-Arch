...
const isWorkOSConfigured = false;
...
const Authenticated: React.ComponentType<{ children: React.ReactNode }> = ({ children }) => <>{children}</>;

const Unauthenticated: React.ComponentType<{ children: React.ReactNode }> = () => null;

const AuthLoading: React.ComponentType<{ children: React.ReactNode }> = () => null;
