...
See: k12-api-enrollment README (external repo)
...
See: k12-web-enrollment README (external repo)
...
See: Infra README (internal) – located under infra/terraform/ (add once available)
...
See: k12-test-api-postman README (external repo)
...
- API README (external repo: k12-api-enrollment)
- Web README (external repo: k12-web-enrollment)
- [Infra README](../../../infra/terraform/README.md)
- Testing README (external repo: k12-test-api-postman)
