...
A site built with markdown-sync framework.. Write markdown, sync from the terminal. Your content is instantly available to browsers, LLMs, and AI agents. Built on Convex and Netlify.
...
- **Site Name**: K12 portal
- **Site Title**: A markdown-powered site
- **Site URL**: http://localhost:5173
- **Total Posts**: 0
- **Total Pages**: 0
- **Last Updated**: 2026-02-01T03:46:11.477Z
