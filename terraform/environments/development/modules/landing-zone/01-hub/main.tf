...
module "firewall" {
  source                             = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/firewall"
...
module "bastion" {
  source                = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/bastion"
