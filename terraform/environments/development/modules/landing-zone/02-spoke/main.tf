...
module "naming" {
  source       = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/naming"
...
module "vnet" {
  source            = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/networking/vnet"
...
module "nsgContainerAppsEnvironmentNsg" {
  source            = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/networking/nsg"
...
module "peeringSpokeToHub" {
  source         = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/networking/peering"
...
module "vm" {
  source                = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/vms"
  osType                = "Linux"
  location              = var.location
  tags                  = var.tags
...
module "logAnalyticsWorkspace" {
  source            = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/monitoring/log-analytics"
  resourceGroupName = azurerm_resource_group.spokeResourceGroup.name
  location          = var.location
...
module "diagnostics" {
  source                  = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/diagnostics"
...
module "routeTable" {
  source            = "../../../../../../docs/aca-landing-zone-accelerator/scenarios/shared/terraform/modules/networking/route-table"
