locals {
  ...
  lz_hub_vnet_address_prefixes             = ["10.30.0.0/16"]
  lz_gateway_subnet_address_prefix         = "10.30.0.0/24"
  lz_firewall_subnet_address_prefix        = "10.30.1.0/24"
  lz_firewall_mgmt_subnet_address_prefix   = "10.30.2.0/24"
  lz_bastion_subnet_address_prefixes       = ["10.30.3.0/26"]
  lz_spoke_resource_group_name             = ""
  lz_spoke_vnet_address_prefixes           = ["10.40.0.0/16"]
  lz_infra_subnet_address_prefix           = "10.40.0.0/23"
  lz_private_endpoints_subnet_address_pref = "10.40.2.0/24"
  lz_app_gateway_subnet_address_prefix     = "10.40.3.0/24"
  lz_jumpbox_subnet_address_prefix         = "10.40.4.0/24"
