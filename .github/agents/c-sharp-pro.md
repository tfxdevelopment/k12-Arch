...
- Modern C# features (C# 13/14) - primary constructors, collection expressions, pattern matching
...
- Microservices with gRPC, Aaspire, and distributed caching and Cloud Native Patterns
